...
export const env = createEnv({
  ...
  server: {
    ...
    MONGO_INITDB_DATABASE_USERNAME: z.string(),
    MONGO_INITDB_DATABASE_PASSWORD: z.string(),
    MONGO_INITDB_DATABASE_NAME: z.string(),
    MONGO_INITDB_DATABASE_PORT_INTERNAL: z.string(),
    MONGO_INITDB_SERVICE_NAME: z.string(),
    APP_NAME: z.string(),
    PORT: z.string(),
    NODE_ENV: z
    ...
    EMAIL_RECEIVER_PASSWORD: z.string(),
    EMAIL_RECEIVER_HOST: z.string(),
    EMAIL_RECEIVER_PORT: z.string(),
  ...
  */
  ...
  runtimeEnv: {
    ...
    MONGO_INITDB_DATABASE_NAME: process.env.MONGO_INITDB_DATABASE_NAME,
    MONGO_INITDB_DATABASE_PORT_INTERNAL: process.env.MONGO_INITDB_DATABASE_PORT_INTERNAL,
    MONGO_INITDB_SERVICE_NAME: process.env.MONGO_INITDB_SERVICE_NAME,
    ...
    EMAIL_RECEIVER_PASSWORD: process.env.EMAIL_RECEIVER_PASSWORD,
    EMAIL_RECEIVER_HOST: process.env.EMAIL_RECEIVER_HOST,
    EMAIL_RECEIVER_PORT: process.env.EMAIL_RECEIVER_PORT,
