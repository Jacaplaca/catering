...
import OrderDayExpandedRow from '@root/app/specific/components/Orders/ByDay/ExpandedRow';

const OrdersByDayTable: FunctionComponent = () => {
...
export default OrdersByDayTable;