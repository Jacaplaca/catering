...
import useRemoveKitchen from '@root/app/specific/components/Kitchens/actions/useRemove';
import { type TableActionType } from '@root/types';
import { useState } from 'react';

const useKitchenAction = ({
    rows,
    onSuccess,
}: {
    rows: string[],
    ...
    const remove = useRemoveKitchen({ onSuccess, ids: idsChecked })
...
export default useKitchenAction;