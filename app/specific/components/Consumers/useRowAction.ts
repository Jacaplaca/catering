...
import useRemoveConsumer from '@root/app/specific/components/Consumers/actions/useRemove';
import { type TableActionType } from '@root/types';
import { useState } from 'react';

const useConsumerAction = ({
    rows,
    onSuccess,
}: {
    rows: string[],
    ...
    const remove = useRemoveConsumer({ onSuccess, ids: idsChecked })
...
export default useConsumerAction;