        ...
        <>
            ...
            <TableWrapper>
                <TableHeader
                    ...
                    searchPlaceholder={'dieticians:search_placeholder'}
                ><MyButton
                    onClick={handleInviteOpen}
                    icon='fas fa-user-plus'
                    id={t(dictionary, 'dieticians:add_dietician')}
                    ariaLabel={t(dictionary, 'dieticians:add_dietician')}
                >{t(dictionary, 'dieticians:add_dietician')}</MyButton>
                </TableHeader>
                <QuickFilterRow
                    dictionary={dictionary}
                    columns={columns}
