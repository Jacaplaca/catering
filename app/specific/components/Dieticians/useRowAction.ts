...
import useRemoveDietician from '@root/app/specific/components/Dieticians/actions/useRemove';
import { type TableActionType } from '@root/types';
import { useState } from 'react';

const useDieticianAction = ({
    rows,
    onSuccess,
}: {
    rows: string[],
    ...
    const remove = useRemoveDietician({ onSuccess, ids: idsChecked })
...
export default useDieticianAction;