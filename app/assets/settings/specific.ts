const specificSettings = {
    ...
    "PRIVATE:table-columns:order-for-kitchen:STRING_ARRAY": "deliveryDay, status, client.name, breakfastStandard, breakfastDietCount, lunchStandard, lunchDietCount, dinnerStandard, dinnerDietCount, sentToCateringAt",
    "PRIVATE:table-columns:order-for-manager:STRING_ARRAY": "deliveryDay, status, client.name, breakfastStandard, breakfastDietCount, lunchStandard, lunchDietCount, dinnerStandard, dinnerDietCount, sentToCateringAt",
