...
const settingsDefault = {
  ...
  "PRIVATE:token:confirmSignupByEmailValiditySec:NUMBER": 60 * 60 * 24 * 7,
  "PUBLIC:token:confirmNewEmailValiditySec:NUMBER": 60 * 60 * 24 * 7,
  "PUBLIC:token:invitationValiditySec:NUMBER": 60 * 60 * 24 * 7,
